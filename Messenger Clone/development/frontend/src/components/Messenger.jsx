...
import { FaEllipsisH,FaEdit,FaSignOutAlt } from "react-icons/fa";
                ...
                <div className='left-side'>
                    <div className='top'>
                        <div className='image-name'>
                            <div className='image'>
                                <img src={`./image/${myInfo.image}`} alt={myInfo.image} title={myInfo.userName} />
                            </div>
                            <div className='name'>
                        ...
                        <div className='icons'>
                            ...
                            <div onClick={() => setHide(!hide) } className='icon' title='Mais opções'>
                                <FaEllipsisH />
                            </div>
                  ...
                  <div className='friend-search'>
                      <div className='search'>
                        ...
                        <input onChange={search} type='text' placeholder='Pesquisar' title='Caixa de texto de pesquisa' className='form-control'/>
                      </div>
                  </div>
